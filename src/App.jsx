...
function App() {
    ...
    function CallApi() {
        ...
        //se for rodar o projeto localmente usar `https://cors-anywhere.herokuapp.com/https://api.deezer.com/search?q=${artistName}` `/api/search?q=${artistName}`  no fetch.
        const searchEndpoint = `/api/search?q=${artistName}` ;
